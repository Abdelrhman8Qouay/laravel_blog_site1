...
npm run watch
Note: if not work then add to (package.json)file scripts{"watch": "npm run watch"}

### If Layouts Folder 📁 Not Exist
    ## Add The Main Files To The Page
    <head>
        <meta charset="utf-8">
...
### Else
    ## Configuring The environment To Work With Exist Layouts Folder 📁
    1- make instead (welcome)file -> (index)file
    2- Inside (index)file
        @extends('layouts.app') <!-- to take the already exist (app)file and use it in all of your pages for your project -->
